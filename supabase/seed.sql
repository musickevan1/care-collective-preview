-- Care Collective Demo Data Seed Script with Maureen's Admin Account
...
-- Insert demo profiles with VALID UUIDs (only 0-9, a-f allowed)
INSERT INTO profiles (id, name, location, is_admin, created_at) VALUES
  -- Maureen's Admin user
  ('a0000000-0000-0000-0000-000000000000', 'Maureen Templeman', 'Springfield, MO', true, NOW() - INTERVAL '60 days'),
  ...
  ('a7777777-7777-7777-7777-777777777777', 'Patricia Parent', 'Republic, MO', false, NOW() - INTERVAL '10 days'),
  ('b8888888-8888-8888-8888-888888888888', 'Michael Student', 'Springfield, MO', false, NOW() - INTERVAL '5 days')
...
INSERT INTO help_requests (id, user_id, title, description, category, urgency, status, helper_id, created_at, updated_at) VALUES
  ...
  ('a1111111-1111-1111-1111-111111111111', 
   ...
   'groceries-meals', 'urgent', 'open', NULL, 
  ...
  ('a2222222-2222-2222-2222-222222222222', 
   ...
   'transportation-errands', 'critical', 'open', NULL, 
  ...
  ('a3333333-3333-3333-3333-333333333333', 
   ...
   'household-yard', 'normal', 'open', NULL, 
  ...
  ('a4444444-4444-4444-4444-444444444444', 
   ...
   'health-caregiving', 'urgent', 'open', NULL, 
  ...
  ('a5555555-5555-5555-5555-555555555555', 
   ...
   'household-yard', 'normal', 'in_progress', 
  ...
  ('a7777777-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 
   ...
   'household-yard', 'urgent', 'in_progress', 
  ...
  ('a8888888-8888-8888-8888-888888888888', 
   ...
   'health-caregiving', 'critical', 'completed', 
  ...
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 
   ...
   'groceries-meals', 'normal', 'completed', 
   'e5555555-5555-5555-5555-555555555555', 
  ...
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', 
   ...
   'household-yard', 'urgent', 'cancelled', NULL, 
  ...
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', 
   ...
   'transportation-errands', 'normal', 'cancelled', NULL, 
