...
export default function AnimatedGradientText() {
  return (
    ...
    >
      <span
        className="font-black bg-gradient-to-r from-sage via-sage-light via-dusty-rose via-tan to-primary bg-clip-text text-transparent bg-[length:300%_auto] animate-gradient-x"
        style={{
