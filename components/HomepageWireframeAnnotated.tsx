...
function HeroWireframeAnnotated(): ReactElement {
  return (
    <section className="relative min-h-[85vh] bg-[#FBF2E9] overflow-hidden">
      <Annotation>HERO - bg: #FBF2E9 (cream), overflow-hidden</Annotation>
      
      {/* Background Blobs with annotations */}
      <div className="absolute inset-0 pointer-events-none">
        {/* Large sage blob - top left (responsive) */}
        <div className="relative">
          ...
          />
          <ShapeLabel className="top-20 left-20 hidden sm:block">
            SAGE: Responsive (mobile: 70%/50%, md: 55%/70%)
          </ShapeLabel>
        </div>
        
        {/* Dusty rose blob - bottom right corner (responsive) */}
        <div className="relative">
          <div 
            ...
            style={{ transform: 'rotate(10deg)' }}
          />
          <ShapeLabel className="bottom-[20%] right-[15%] hidden sm:block">
            DUSTY ROSE: bottom-right corner (mobile: 50%/35%, md: 40%/45%)
          </ShapeLabel>
        </div>
        
        {/* Small tan accent - right side (hidden on mobile/tablet) */}
        <div className="relative">
          <div 
          ...
          />
          <ShapeLabel className="top-[30%] right-[10%] hidden lg:block">
            TAN: Hidden until md+
          </ShapeLabel>
        </div>
      </div>
