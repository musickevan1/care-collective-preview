  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          <Link href="/requests">
            <Card data-testid="stats-card-requests" className="hover:bg-muted/50 hover:shadow-md transition-all cursor-pointer h-full">
          ...
          <Link href="/messages">
            <Card data-testid="stats-card-messages" className="hover:bg-muted/50 hover:shadow-md transition-all cursor-pointer h-full">
              <CardHeader className="pb-2">
          ...
          <Card data-testid="stats-card-impact" className="hover:shadow-md transition-shadow h-full">
            <CardHeader className="pb-2">
